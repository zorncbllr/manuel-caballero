...
function HeroButtons() {
  return (
    <div className="flex items-center gap-4">
      <div className="group relative transition-transform duration-300 ease-out hover:-translate-y-0.5 active:scale-[0.98]">
        <Button
      ...
      <div className="group relative transition-transform duration-300 ease-out hover:scale-[1.02] active:scale-[0.98]">
        <Button
          onMouseMove={trackSpotlight}
          variant="outline"
